...
class Login(QDialog):
    ...
    def handleLogin(self):
        if (self.textName.text() == 'yashu' and
            self.textPass.text() == '123'):
            self.accept()
        else:
            QMessageBox.warning(
                self, 'Error', 'Invalide User or Password')
...
class AddStudent(QDialog):
    def __init__(self):
        ...
        self.branchCombo.addItem("Information Science")
...
class Window(QMainWindow):
    def __init__(self):
        ...
        self.btnEnterStudentFont.setPointSize(8.5)
        ...
        self.btnEnterPaymentFont.setPointSize(8.5)
        ...
        self.btnShowStudentDetailsFont.setPointSize(8.5)
        ...
        self.btnShowPaymentDetailsFont.setPointSize(8.5)
